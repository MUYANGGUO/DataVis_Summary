...
"""
def author():                                                                                             
        return 'mguo34' # replace sroutray3 with your Georgia Tech username.                                                                                             
                                                                                              
def gtid():                                                                                               
    return  902906758 # replace with your GT ID number      
...
### Implement your code here
#############################################
                ## for the sum term of all source nodes to the target nodes
                new_scores[target] = new_scores[target]+(scores[source])/(self.node_degree[source])

            final_scores = []
            for i in range ((self.max_node_id+1)):
                 final_scores.append((1-damping_factor)*(node_weights[i])+damping_factor*new_scores[i])
